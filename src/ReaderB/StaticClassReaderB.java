...
public class StaticClassReaderB {
  ...
  public static java.lang.Integer GetQandAntenna(
      AtomicReference<java.lang.Byte> ConAddr,
      AtomicReference<java.lang.Byte> Qvalue,
      AtomicReference<java.lang.Byte> Ant_Mode,
      AtomicReference<java.lang.Byte> Ant_SWTcnt,
      AtomicReference<java.lang.Byte> AntInfoEn,
  ...
  @MethodTypeAnnotation(type = "Method")
  public static java.lang.Integer SetReadPauseTime(
      AtomicReference<java.lang.Byte> ConAddr,
      AtomicReference<java.lang.Byte> ReadPauseTime,
      java.lang.Integer PortHandle) {
    try {
      java.lang.Integer res =
          Javonet.getType("ReaderB.StaticClassReaderB")
              .invoke("SetReadPauseTime", new NRef(ConAddr), new NRef(ReadPauseTime), PortHandle);
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  @MethodTypeAnnotation(type = "Method")
  public static java.lang.Integer SetAntenna(
      AtomicReference<java.lang.Byte> ConAddr,
      java.lang.Byte Ant_Mode,
      java.lang.Byte Ant_SWTcnt,
      java.lang.Byte AntInfoEn,
      java.lang.Integer PortHandle) {
    try {
      java.lang.Integer res =
          Javonet.getType("ReaderB.StaticClassReaderB")
              .invoke("SetAntenna", new NRef(ConAddr), Ant_Mode, Ant_SWTcnt, AntInfoEn, PortHandle);
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  @MethodTypeAnnotation(type = "Method")
  public static java.lang.Integer SetQvalue(
      AtomicReference<java.lang.Byte> ConAddr,
      java.lang.Byte Qvalue,
      java.lang.Integer PortHandle) {
    try {
      java.lang.Integer res =
          Javonet.getType("ReaderB.StaticClassReaderB")
              .invoke("SetQvalue", new NRef(ConAddr), Qvalue, PortHandle);
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  @MethodTypeAnnotation(type = "Method")
  public static java.lang.Integer GetAntenna(
      AtomicReference<java.lang.Byte> ConAddr,
      AtomicReference<java.lang.Byte> Ant_No,
      java.lang.Integer PortHandle) {
    try {
      java.lang.Integer res =
          Javonet.getType("ReaderB.StaticClassReaderB")
              .invoke("GetAntenna", new NRef(ConAddr), new NRef(Ant_No), PortHandle);
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
